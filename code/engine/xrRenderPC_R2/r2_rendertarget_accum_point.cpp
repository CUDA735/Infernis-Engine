...
void CRenderTarget::accum_point(light* L) {
    ...
    RCache.set_Stencil(TRUE, D3DCMP_LESSEQUAL, 0x01, 0xff, 0xff, D3DSTENCILOP_KEEP,
                       D3DSTENCILOP_KEEP, D3DSTENCILOP_REPLACE);
    draw_volume(L);
    ...
    // *****************************	Minimize overdraw
    // ************************************* Select shader (front or back-faces), *** back, if
    // intersect near plane
...
#define FOURCC_GET4 MAKEFOURCC('G', 'E', 'T', '4')
        ...
        RCache.set_Stencil(TRUE, D3DCMP_LESSEQUAL, dwLightMarkerID, 0xff, 0x00, D3DSTENCILOP_KEEP,
...
#define FOURCC_GET1 MAKEFOURCC('G', 'E', 'T', '1')
    ...
    // dwLightMarkerID					+=	2;	// keep lowest bit always setted
    // up
