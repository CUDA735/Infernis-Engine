...
void CHelmet::Load(LPCSTR section) {
    ...
    m_fShowNearestEnemiesDistance =
        READ_IF_EXISTS(pSettings, r_float, section, "nearest_enemies_show_dist", 0.0f);
}
...
bool CHelmet::install_upgrade_impl(LPCSTR section, bool test) {
    ...
    result |= process_if_exists(section, "nearest_enemies_show_dist", &CInifile::r_float,
