...
void CObjectFactory::register_classes() {
    ...
    //	add<CSE_SpawnGroup>											(CLSID_AI_SPAWN_GROUP
    //,"spawn_group");
    ...
    //  [8/15/2006]
    //  [8/17/2006]
    ADD(CWeaponMagazinedWGrenade, CSE_ALifeItemWeaponMagazinedWGL, CLSID_OBJECT_W_MAGAZWGL,
        "wpn_wmaggl");
    //  [8/17/2006]
	...
	ADD(CBackpack, CSE_ALifeItem, CLSID_EQUIPMENT_BACKPACK, "backpack");
    ...
    //.	ADD(CAmebaZone				,CSE_ALifeZoneVisual			,CLSID_Z_AMEBA
    //,"ameba_zone");
    ...
    //	ADD(CTrigger				,CSE_Trigger					,CLSID_OBJECT_TRIGGER
    //,"trigger");
    ...
    ADD(CPhysicsSkeletonObject, CSE_ALifePHSkeletonObject, CLSID_PH_SKELETON_OBJECT,
        "obj_phskeleton");
    ADD(CDestroyablePhysicsObject, CSE_ALifeObjectPhysic, CLSID_PHYSICS_DESTROYABLE,
